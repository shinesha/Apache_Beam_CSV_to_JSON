...
_STATEKEY = _descriptor.Descriptor(
  ...
  nested_types=[_STATEKEY_RUNNER, _STATEKEY_ITERABLESIDEINPUT, _STATEKEY_MULTIMAPSIDEINPUT, _STATEKEY_MULTIMAPKEYSSIDEINPUT, _STATEKEY_BAGUSERSTATE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
